...
public abstract class SqlDB {
	...
	public static JSONObject convertResToJSON(ResultSet zRes) {
		...
		try {
			...
			//Get the Headers..
			ResultSetMetaData rsmd = zRes.getMetaData();
			int columnnum          = rsmd.getColumnCount();
		...
		//Log.log("CONV:"+results.toString());
		
		return results;
	}
	
	public static JSONObject getSQLErrorJSON(Exception zEXC) {
		Log.log(zEXC.toString());
		...
		results.put("rows", new JSONArray());
		results.put("results", false);
		results.put("error", zEXC.toString());
		
		return results;
	}
	
	public static JSONObject getSQLSuccessUpdateJSON() {
